...
st.markdown('<p class="center fade-in" style="font-size:32px;">03 de Octubre 2026</p>', unsafe_allow_html=True)
...
<div style='color:#d16d6d; font-size:32px;'>

<span style="font-style:italic; font-size:32px;">
...
<div class="center fade-in">
    ...
    <a href="https://music.youtube.com/playlist?list=PLmptaA43xE8G1tBG9apqVDBuNOFJu_3DA&jct=uGAXmsesB9qP_dFcz9T79g" target="_blank">
...
# --- LISTA INVITADOS ---
invitados = {
    "CAMILA ULIBARRI": 0, "GONZALO Y JIMENA": 0, "AGUSTIN Y JEANETTE": 0,
    "LEONEL ROBLEDO": 0, "VICTORIA CABRERA": 0, "MATIAS DELINA": 0, "FEDERICO CONFALONE": 0,
    "CECILIA SPACCAROTELLA": 1, "GUADALUPE Y GONZALO": 0,"FRANCO VALLONI": 1,
    "SEBASTIAN Y ELIZABETH": 0, "LARA LUCIA PEREZ MARTIN": 0, "PABLO JERMAK": 0,
    "SARA RISCAL": 0, "CAMI AGUERO": 0, "DELFINA ROJAS": 0, "GERMAN ANZOATEGUI": 0,
    "NICOLAS Y CAMILA": 0, "ARIADNA Y FLAVIA": 0, "AYELEN AGUILERA": 0,
    "MIRANDA TRENQUE": 0, "JUAN MANUEL Y BELEN": 0, "EUGENIA BALL": 0, "JONATHAN VIZCAYA": 0,
    "FRANCISCO KURYLOWICZ": 0, "CAROLINA PAGLIA": 0, "VICTORIA CSAMBAL": 0, "JONATHAN MOLINA": 0,
    "EVELIN MARTINEZ": 0, "NAHUEL Y BRENDA": 0, "MONICA Y NICOLAS": 0,
    "ROMINA Y NICOLAS": 0, "CELESTE DE LEO": 0, "AGUSTINA MEDINA": 0,
    "TIZIANA ORTIGOZA": 0, "WALTER Y MARIELA": 0, "IVAN Y MICAELA": 0, "EZEQUIEL NARVAEZ": 0,
    "CRISTIAN Y LUCIANA ": 0, "ROLDOLFO PORTILLO": 1, "ZORAIDA BELLAGIO": 0, "ANDRES LEAL": 0,
    "MAURO BAZZANA": 0, "ENRICO SALVUCCI": 0,"RODOLFO KUCHEN": 0, "MANUEL PRIETO": 0, "AGUSTIN SEQUEYRA": 0,
    "LAUTARO LANARI": 0, "MANUEL Y ANGIE": 0, "RENZO CEJAS": 0, "ALEJANDRO OMAÑA": 0, "NICOLAS DE LEO": 0,
    "ANTONELA Y LIONEL": 0 
}
...
try:
    ...
    img_qr = get_base64("qr_casamiento_rosa_transparente.png")
